...
import { Plus, ChevronRight, Inbox, UserRoundCheck } from "lucide-react";
    ...
    <div className="space-y-5">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-slate-500">共 {students.length} 名已确认学生{pending.length > 0 ? ` · ${pending.length} 位新生待确认` : ""}</p>
        </div>
      ...
      <OkBanner ok={ok === "confirmed" ? "已确认入库 ✅ 该学生已进入正式列表；可在其档案里生成访问码发给学生。" : null} />
